...
const formSchema = z.object({
    ...
    peso: z.preprocess(parseDecimal, z.number({ error: "Digite um número válido" }).min(0, "Peso inválido")),
    cansaco: z.number().min(0).max(10),
    horas_treino_7d: z.preprocess(parseDecimal, z.number({ error: "Digite um número válido" }).min(0)),
    ...
    duracao_treino: z.preprocess(parseDecimal, z.number({ error: "Digite um número válido" }).min(0)),
